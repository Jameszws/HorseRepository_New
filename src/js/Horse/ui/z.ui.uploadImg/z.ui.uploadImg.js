...
define([],function() {
    ...
    uploadImg.prototype = {
        ...
        createInputFile: function () {
            ...
            var handleEvent = Horse.util.delegate(this._handleOnchange, this, [{ fileEl: fileEl}]);
            //注册change事件
        ...
        _handleOnchange: function (params) {
            ...
            var handleEvent = Horse.util.delegate(this._handleCheckBoxClick, this, [{ obj: childInput, fileElObj: fileEl}]);
